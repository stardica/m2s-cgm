...
print tabulate(table, headers=["Stat P0", "P0_I", "P0_D", "P0_L2", "P0_L3"], tablefmt="orgtbl",  numalign="right") 
f = open('table.txt', 'w')
f.write(tabulate(table, headers=["Stat P0", "P0_I", "P0_D", "P0_L2", "P0_L3"], tablefmt="orgtbl", numalign="right"))
f.close()
