...
struct elf_symbol_t *elf_symbol_get_by_address(struct elf_file_t *elf_file, unsigned int addr, unsigned int *offset_ptr);
...
int elf_symbol_read_content(struct elf_file_t *elf_file, struct elf_symbol_t *symbol, struct elf_buffer_t *elf_buffer);
