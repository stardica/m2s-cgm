...
struct x86_file_desc_t *x86_file_desc_table_entry_new(struct x86_file_desc_table_t *table, enum x86_file_desc_kind_t kind, int host_fd, char *path, int flags);
struct x86_file_desc_t *x86_file_desc_table_entry_new_guest_fd(struct x86_file_desc_table_t *table, enum x86_file_desc_kind_t kind, int guest_fd, int host_fd, char *path, int flags);
