 ...
 *
 *	extern struct class_t X86EmuClass;
 *
 * 	struct _X86Emu
 * 	{
 *		Emu __parent;
 ...
 *		//beginning of next cycle. This flag is set any time a context changes it
 ...
 *
 *	//Cast to class
 *	static inline X86Emu *asX86Emu(void *p)
 *	{
 *	((isX86Emu(p)) ? (void) (0) : __assert_fail ("isX86Emu(p)", "/home/stardica/Desktop/m2srev2019/src/arch/x86/emu/emu.h", 167, __PRETTY_FUNCTION__));
 *	return (X86Emu *) p;
 *	}
 */
