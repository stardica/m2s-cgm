...
void switch_dump_stats(void){
	...
	for(i = 0; i < num_cores; i++)
	{
		...
		CGM_STATS(cgm_stats_file, "NumberSwitchCtrlLoops = %llu\n", cgm_stat->switch_total_wakes[i]);
		CGM_STATS(cgm_stats_file, "SwitchOccupance = %0.2f\n", (double) cgm_stat->switch_total_wakes[i]/ (double) P_TIME);
		CGM_STATS(cgm_stats_file, "NumberLinks = %llu\n", cgm_stat->switch_total_links[i]);
		CGM_STATS(cgm_stats_file, "MaxNumberLinks = %d\n", cgm_stat->switch_max_links[i]);
		CGM_STATS(cgm_stats_file, "AveNumberLinksPerCtrlLoop = %.02f\n", (double)cgm_stat->switch_total_links[i]/(double)cgm_stat->switch_total_wakes[i]);
		CGM_STATS(cgm_stats_file, "NorthIOTransfers = %llu\n", cgm_stat->switch_north_io_transfers[i]);
		CGM_STATS(cgm_stats_file, "NorthIOCycles = %llu\n", cgm_stat->switch_north_io_transfer_cycles[i]);
		CGM_STATS(cgm_stats_file, "NorthIOBytesTransfered = %llu\n", cgm_stat->switch_north_io_bytes_transfered[i]);
		CGM_STATS(cgm_stats_file, "NorthRxQueueMaxDepth = %llu\n", cgm_stat->switch_north_rxqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "NorthRxQueueAveDepth = %0.2f\n", cgm_stat->switch_north_rxqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "NorthTxQueueMaxDepth = %llu\n", cgm_stat->switch_north_txqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "NorthTxQueueAveDepth = %0.2f\n", cgm_stat->switch_north_txqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "EastIOTransfers = %llu\n", cgm_stat->switch_east_io_transfers[i]);
		CGM_STATS(cgm_stats_file, "EastIOCycles = %llu\n", cgm_stat->switch_east_io_transfer_cycles[i]);
		CGM_STATS(cgm_stats_file, "EastIOBytesTransfered = %llu\n", cgm_stat->switch_east_io_bytes_transfered[i]);
		CGM_STATS(cgm_stats_file, "EastRxQueueMaxDepth = %llu\n", cgm_stat->switch_east_rxqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "EastRxQueueAveDepth = %0.2f\n", cgm_stat->switch_east_rxqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "EastTxQueueMaxDepth = %llu\n", cgm_stat->switch_east_txqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "EastTxQueueAveDepth = %0.2f\n", cgm_stat->switch_east_txqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "SouthIOTransfers = %llu\n", cgm_stat->switch_south_io_transfers[i]);
		CGM_STATS(cgm_stats_file, "SouthIOCycles = %llu\n", cgm_stat->switch_south_io_transfer_cycles[i]);
		CGM_STATS(cgm_stats_file, "SouthIOBytesTransfered = %llu\n", cgm_stat->switch_south_io_bytes_transfered[i]);
		CGM_STATS(cgm_stats_file, "SouthRxQueueMaxDepth = %llu\n", cgm_stat->switch_south_rxqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "SouthRxQueueAveDepth = %0.2f\n", cgm_stat->switch_south_rxqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "SouthTxQueueMaxDepth = %llu\n", cgm_stat->switch_south_txqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "SouthTxQueueAveDepth = %0.2f\n", cgm_stat->switch_south_txqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "WestIOTransfers = %llu\n", cgm_stat->switch_west_io_transfers[i]);
		CGM_STATS(cgm_stats_file, "WestIOCycles = %llu\n", cgm_stat->switch_west_io_transfer_cycles[i]);
		CGM_STATS(cgm_stats_file, "WestIOBytesTransfered = %llu\n", cgm_stat->switch_west_io_bytes_transfered[i]);
		CGM_STATS(cgm_stats_file, "WestRxQueueMaxDepth = %llu\n", cgm_stat->switch_west_rxqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "WestRxQueueAveDepth = %0.2f\n", cgm_stat->switch_west_rxqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "WestTxQueueMaxDepth = %llu\n", cgm_stat->switch_west_txqueue_max_depth[i]);
		CGM_STATS(cgm_stats_file, "WestTxQueueAveDepth = %0.2f\n", cgm_stat->switch_west_txqueue_ave_depth[i]);
		CGM_STATS(cgm_stats_file, "\n");
	}

	CGM_STATS(cgm_stats_file, "[Switch_SA]\n");
	CGM_STATS(cgm_stats_file, "NumberSwitchCtrlLoops = %llu\n", cgm_stat->switch_total_wakes[num_cores]);
	CGM_STATS(cgm_stats_file, "SwitchOccupance = %0.2f\n", (double) cgm_stat->switch_total_wakes[num_cores]/ (double) P_TIME);
	CGM_STATS(cgm_stats_file, "NumberLinks = %llu\n", cgm_stat->switch_total_links[num_cores]);
	CGM_STATS(cgm_stats_file, "MaxNumberLinks = %d\n", cgm_stat->switch_max_links[num_cores]);
	CGM_STATS(cgm_stats_file, "AveNumberLinksPerCtrlLoop = %.02f\n", (double)cgm_stat->switch_total_links[num_cores]/(double)cgm_stat->switch_total_wakes[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthIOTransfers = %llu\n", cgm_stat->switch_north_io_transfers[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthIOCycles = %llu\n", cgm_stat->switch_north_io_transfer_cycles[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthIOBytesTransfered = %llu\n", cgm_stat->switch_north_io_bytes_transfered[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthRxQueueMaxDepth = %llu\n", cgm_stat->switch_north_rxqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthRxQueueAveDepth = %0.2f\n", cgm_stat->switch_north_rxqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthTxQueueMaxDepth = %llu\n", cgm_stat->switch_north_txqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "NorthTxQueueAveDepth = %0.2f\n", cgm_stat->switch_north_txqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "EastIOTransfers = %llu\n", cgm_stat->switch_east_io_transfers[num_cores]);
	CGM_STATS(cgm_stats_file, "EastIOCycles = %llu\n", cgm_stat->switch_east_io_transfer_cycles[num_cores]);
	CGM_STATS(cgm_stats_file, "EastIOBytesTransfered = %llu\n", cgm_stat->switch_east_io_bytes_transfered[num_cores]);
	CGM_STATS(cgm_stats_file, "EastRxQueueMaxDepth = %llu\n", cgm_stat->switch_east_rxqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "EastRxQueueAveDepth = %0.2f\n", cgm_stat->switch_east_rxqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "EastTxQueueMaxDepth = %llu\n", cgm_stat->switch_east_txqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "EastTxQueueAveDepth = %0.2f\n", cgm_stat->switch_east_txqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthIOTransfers = %llu\n", cgm_stat->switch_south_io_transfers[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthIOCycles = %llu\n", cgm_stat->switch_south_io_transfer_cycles[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthIOBytesTransfered = %llu\n", cgm_stat->switch_south_io_bytes_transfered[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthRxQueueMaxDepth = %llu\n", cgm_stat->switch_south_rxqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthRxQueueAveDepth = %0.2f\n", cgm_stat->switch_south_rxqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthTxQueueMaxDepth = %llu\n", cgm_stat->switch_south_txqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "SouthTxQueueAveDepth = %0.2f\n", cgm_stat->switch_south_txqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "WestIOTransfers = %llu\n", cgm_stat->switch_west_io_transfers[num_cores]);
	CGM_STATS(cgm_stats_file, "WestIOCycles = %llu\n", cgm_stat->switch_west_io_transfer_cycles[num_cores]);
	CGM_STATS(cgm_stats_file, "WestIOBytesTransfered = %llu\n", cgm_stat->switch_west_io_bytes_transfered[num_cores]);
	CGM_STATS(cgm_stats_file, "WestRxQueueMaxDepth = %llu\n", cgm_stat->switch_west_rxqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "WestRxQueueAveDepth = %0.2f\n", cgm_stat->switch_west_rxqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "WestTxQueueMaxDepth = %llu\n", cgm_stat->switch_west_txqueue_max_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "WestTxQueueAveDepth = %0.2f\n", cgm_stat->switch_west_txqueue_ave_depth[num_cores]);
	CGM_STATS(cgm_stats_file, "\n");
